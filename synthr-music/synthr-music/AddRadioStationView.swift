...
struct AddRadioStationView: View {
    ...
    @State private var stationGenre = ""
    @State private var stationDescription = ""
    ...
    var body: some View {
        NavigationView {
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        ...
                        VStack(spacing: 8) {
                            ...
                            Text("Enter the details for your new radio station")
                                .font(.subheadline)
            ...
            .navigationTitle("Add Radio Station")
    ...
    private func addStation() {
        ...
        if dataManager.radioStations.contains(where: { $0.url == trimmedURL }) {
